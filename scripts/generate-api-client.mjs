...
const requiredContractFragments = [
  ...
  'operationId: transitionExpenseStatus',
  ...
  'operationId: transitionWorkLogStatus',
  ...
  'operationId: createProposalMessageDraft',
  'operationId: getLatestProposalMessageDraft',
  'operationId: updateProposalMessageDraft',
  'operationId: reviewProposalMessageDraft',
