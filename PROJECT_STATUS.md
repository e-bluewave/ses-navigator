...
|----|----|
|Version|0.1.0 (MVP)|
|Status|🟢 DB基盤完了／AI・プロンプト設計初版完了／実装準備中|
...
- 未作成設計文書：`09_認証設計.md`、`11_テスト設計.md`、`12_運用設計.md`

# 次にやること

1. `docs/09_認証設計.md`を作成する
2. `docs/11_テスト設計.md`を作成する
3. `docs/12_運用設計.md`を作成する
4. RLS・FK判定用インデックスと`row_version`不足を継続確認する
5. フロントエンド・API実装へ進む
